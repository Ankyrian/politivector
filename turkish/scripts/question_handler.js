...
function nextQuestion() {
    ...
    document.getElementById('question-number').innerHTML = `Soru ${currentIndex + 1} / ${questions.length}`
}
...
function initializesResults() {
    var generatedUrl = `results_tr.html?d0=${dimensionScores[0][0]},${dimensionScores[0][1]}`;
